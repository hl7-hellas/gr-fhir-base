...
* type 0..1 code "The type of this identifier to be used to determine a purpose of use of this identifier"
  * ^binding.description = "PASSPORT NUMBER | MEDICAL RECORD NUMBER | TAX ID | NATIONAL INSURANCE ID | SOCIAL BENEFICIARY ID | EMPLOYER NUMBER | PROVIDER NUMBER | MEDICAL LICENSE NUMBER | FILLER ID | DEVICE ID | SERIAL NUMBER"
...
* text 1..1 string "The full name as it should be presented/displayed to human reader. This should be provided regardless if family and given are available separately"
...
* text 1..1 string "The full address as it should be presented/displayed to human reader"
* use 0..1 code "Information about the address' purpose"
  * ^binding.description = "HOME | WORK | OLD"
  * ^binding.strength = #example
...
* country 0..1 code "Country name (and country code)"
  * ^binding.description = "#GR \"Greece\" | #CY \"Cyprus\" | #MK \"North Macedonia\" | #AL \"Albania\""
  * ^binding.strength = #example
////////////////////////////////////////////////////////////////////////////////////////////////////
...
* type 0..1 code "Information about contact point type"
  * ^binding.description = "PHONE | EMAIL"
  * ^binding.strength = #example
